/*
  # Populate Templates with Elegant Designs

  1. New Data
    - Clear existing template data
    - Insert 13 meticulously designed invitation templates (3 free, 10 premium)
    - Each template has carefully selected images, color palettes, and font pairings
    - Templates span multiple categories: Classic, Modern, Nature, Romantic
    
  2. Design Philosophy
    - Professional, elegant designs suitable for production
    - Modern aesthetics with attention to typography and color harmony
    - Variety of styles to appeal to different tastes and wedding themes
    - Premium templates offer more sophisticated design elements
*/

-- First, clear existing template data (in correct order to respect foreign keys)
