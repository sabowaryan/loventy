...
DROP POLICY IF EXISTS "Les utilisateurs peuvent lire les remerciements de leurs invita" ON invitation_thank_you;
DROP POLICY IF EXISTS "Les utilisateurs peuvent gérer les remerciements de leurs invi" ON invitation_thank_you;
...
DROP POLICY IF EXISTS "Les utilisateurs peuvent lire les réponses RSVP de leurs invit" ON invitation_rsvp_answers;
...
-- Utilisation d'une condition directe au lieu de is_admin_safe()
...
-- Nous ne recréons pas les fonctions is_admin_safe() et has_role_safe() pour éviter les conflits
-- Nous utilisons directement les conditions dans les politiques