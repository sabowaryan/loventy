...
const PublicLayout: React.FC<PublicLayoutProps> = ({ children }) => {
  ...
  const [currentSection, setCurrentSection] = useRef(null); // Changed to useRef
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (location.pathname === '/') {
        ...
        if (currentSectionId) {
          currentSection.current = currentSectionId; // Update ref
        }
      }
    };
