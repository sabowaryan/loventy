    ...
    <PublicRoute>
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Acceptation des conditions AVANT les champs */}
          <div className="flex items-start space-x-3 p-4 bg-[#D4A5A5]/5 border border-[#D4A5A5]/20 rounded-xl">
            <input
              id="accept-terms"
              type="checkbox"
              checked={acceptTerms}
              onChange={(e) => setAcceptTerms(e.target.checked)}
              className="mt-1 h-4 w-4 text-[#D4A5A5] focus:ring-[#D4A5A5] border-gray-300 rounded transition-colors duration-200"
              disabled={isLoading || isGoogleLoading}
            />
            <label htmlFor="accept-terms" className="text-sm text-gray-700 leading-relaxed">
              J'accepte les{' '}
              <a href="#" className="text-[#D4A5A5] hover:text-[#E16939] font-medium transition-colors duration-200 underline decoration-dotted">
