...
const PublicLayout: React.FC<PublicLayoutProps> = ({ children }) => {
  ...
  const currentSection = useRef(''); // Changed to useRef and initialized with an empty string
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (location.pathname === '/') {
        ...
        if (currentSectionId) {
          currentSection.current = currentSectionId; // Update ref's current property
        }
      }
    };
